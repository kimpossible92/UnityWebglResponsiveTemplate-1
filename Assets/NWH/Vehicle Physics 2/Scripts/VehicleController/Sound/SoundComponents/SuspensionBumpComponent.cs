    ...
    public partial class SuspensionBumpComponent : SoundComponent
    {
        ...
        public override void Initialize()
        {
            ...
            for (int index = 0; index < _wheelCount; index++)
            {
                ...
                SetupAndRegisterAudioSource(a);
                _prevHasHits.Add(false);
            }
        }
        
        public override bool GetInitAutoSetupSource()
        {
            return false;
        }
            ...
            if (Clip != null && Sources != null && Sources.Count == vc.Wheels.Count)
            {
                ...
                for (int i = 0; i < wheelCount; i++)
                {
                    ...
                    if (!Sources[i].isPlaying)
                    {
                        ...
                        if (wc.isGrounded && _prevHasHits[i] == false || wc.forwardFriction.speed > 0.8f &&
                            (forwardAngle > 10f || forwardAngle < -10f)) // TODO
                        {
