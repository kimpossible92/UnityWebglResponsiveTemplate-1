    ...
    public partial class VehicleController : Vehicle
    {
        ...
        public void UpdateInertiaTensor(float xCoeff = 1f, float yCoeff = 1f, float zCoeff = 1f)
        {
            ...
            Vector3 bodyInertia = new Vector3(
                (vehicleDimensions.y + vehicleDimensions.z) * 0.126f * mass * xCoeff,
                (vehicleDimensions.z + vehicleDimensions.x) * 0.214f * mass * yCoeff,
                (vehicleDimensions.x + vehicleDimensions.y) * 0.072f * mass * zCoeff
            );
